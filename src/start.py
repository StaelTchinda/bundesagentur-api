...
from src.applicants.router.arbeitsagentur import (
    router as arbeitsagentur_applicants_router,
)
...
try:
    ...
    app.include_router(
        arbeitsagentur_applicants_router, tags=["Arbeitsagentur Bewerberbörse"]
    )
