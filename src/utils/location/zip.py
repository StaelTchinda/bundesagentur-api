...
def get_localities_in_radius(country_code: CountryCode, postal_code: Union[Text, int], distance: int, unit: DistanceUnit = DistanceUnit.KM) -> List[RadiusLocality]:
    ...
    if isinstance(json_response, dict):
      ...
      localities_data = json_response
    localities: List[RadiusLocality] = [RadiusLocality(**locality) for locality in localities_data]
    return localities
